 ...
 */
const POSTS = [
  { slug: 'saas-architecture', title: 'The architecture of a $100M SaaS platform',
    cat: 'Engineering', date: 'Apr 2025', read: 8, author: 'david-kim', featured: true,
    excerpt: 'Breaking down the infrastructure decisions that let us scale from zero to 500K daily active users without ever re-platforming — and the two we would make differently now.',
  ...
  { slug: 'llm-fine-tuning', title: 'Why LLM fine-tuning is overrated',
    cat: 'AI/ML', date: 'Apr 2025', read: 6, author: 'elena-vos',
  ...
  { slug: 'design-systems-cost', title: 'The real cost of design systems',
    cat: 'Design', date: 'Mar 2025', read: 5, author: 'sophie-martin',
  ...
  { slug: 'core-web-vitals', title: 'Core Web Vitals: from 45 to 98 in three weeks',
    cat: 'Performance', date: 'Mar 2025', read: 7, author: 'david-kim',
  ...
  { slug: 'mobile-retention', title: 'Mobile retention: the metrics that actually matter',
    cat: 'Growth', date: 'Feb 2025', read: 4, author: 'jennifer-lee',
  ...
  { slug: '3d-on-the-web', title: "3D on the web: what's worth using",
    cat: 'Engineering', date: 'Feb 2025', read: 9, author: 'arinze-okafor',
